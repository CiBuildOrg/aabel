namespace CInfinity.Identity.Webapi
{
    ...
    internal static class InMemoryManager
    {
        ...
        /// <summary>
        /// Gets the users allowed to give consent to the clients to access resources.
        /// </summary>
        /// <returns>
        ...
        public static List<InMemoryUser> GetUsers() =>
            new List<InMemoryUser>
            {
                ...
                {
                    Subject = "uid:vlade",
                    Username = "vlade@cinfinity.com",
                    Password = "password",
                    Claims = new []
                    {
                        new Claim("name", "Vlad Eminovici"),
                        new Claim("website", "http://cinfinity.com")
                    }
                }
            };
        #endregion
